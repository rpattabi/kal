...
xnoremap <SNR>64_VisualNrrwBang :call nrrwrgn#VisualNrrwRgn(visualmode(),'!')
xnoremap <SNR>64_VisualNrrwRgn :call nrrwrgn#VisualNrrwRgn(visualmode(),'')
...
set shortmess=aoO
badd +3 /tmp/Kal.html
badd +5 ~/Dev/kal/sinatra/app.rb
badd +1 ~/Dev/kal/sinatra/views/layout.slim
badd +4 ./views/index.slim
badd +1 ~/Dev/kal/sinatra/views/index.slim
silent! argdel *
edit ~/Dev/kal/sinatra/views/layout.slim
...
setlocal tabstop=2
setlocal tags=~/Dev/kal/.git/html.tags,~/Dev/kal/.git/tags,./tags,./TAGS,tags,TAGS
...
wincmd w
argglobal
edit ~/Dev/kal/sinatra/views/index.slim
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
...
setlocal tabstop=2
setlocal tags=~/Dev/kal/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
